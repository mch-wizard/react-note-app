...
const LoginPage = ({ userID, authenticate }) => (
  <AuthTemplate>
    <Formik initialValues={{ username: '', password: '' }} onSubmit={({ username, password }) => authenticate(username, password)}>
      {({ handleChange, handleBlur, values }) => {
        ...
        return (
          <>
            ...
            <StyledLink to={routes.register}>I want to register!</StyledLink>
          </>
        );
      }}
    </Formik>
